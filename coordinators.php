...
<div class="landingpagewrapper ">
	...
	<div class="sectioncontainer">		
		...
		<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
			<?php details('mohit.jpg','Mohit Singh','');?>
		...
		<div class="sectioncontainer">		
			<div class='section-header  position-center'>
				<p id="sponsors"></p>
				<h1>Chief Coordinators</h1>
				<span class='sectionline'></span>
				<em>The warriors of administration</em>
			</div> 
			...
			<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
				<?php details('gyandeep.jpg','Gyandeep Mishra','9889389190');?>
				<?php details('default.png','Sujeet Chand','9506715996');?>
				<?php details('default.png','Devendra Kr Gond','');?>
				

			</div>
			<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
				<?php details('default.png','Harsh Singh','');?>
				<?php details('default.png','Vivek','');?>
				<?php details('default.png','Rajat','');?>
				
			</div>
			<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
				<?php details('default.png','Atif Mohd','');?>
				<?php details('default.png','Prapunj Tiwari','');?>
				<?php details('default.png','Shubham Desai','');?>
		...
		<div class="sectioncontainer">		
						...
						<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
							<?php details('ajay.jpg','Ajay Pandey','9125580401');?>
							<?php details('kripa.jpg','Kripashanker','8896608650');?>
							<?php details('prakhar.jpg','Prakhar Srivastava','9369168442');?>
						</div>
						<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
							<?php details('ravi.jpg','Ravi Singh Kushwaha','8303210846');?>
						</div>	
		...
		<div class="sectioncontainer">		
				...
				<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
					<?php details('ravishankar.jpg','Ravishankar (CS)','8896101102');?>
			...
			<div class="sectioncontainer">		
				...
				<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' >
					...
					<?php details('paritosh.jpg','Paritosh','9793861928');?>
					<?php details('kripa.jpg','Kripashanker','8896608650');?>
				</div>
				<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' >
				...
				<?php details('default.png','Sachin Pandey',' ');?>
						...
						<div class="sectioncontainer">		
							...
							<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
								...
								<?php details('default.png','Rajat (CE)','8543044314');?>
								<?php details('gyandeep.jpg','Gyandeep (CS)','9889389190');?>
							</div>
							<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
							...
							<div class="sectioncontainer">		
								...
								<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
									...
									<?php details('shubham.jpg','Shubham Singh (CS)','8726609870');?>
								...
								<div class="sectioncontainer">		
									...
									<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
										<?php details('default.png','Atif (ME)','8181036038');?>
										<?php details('meenakshi.jpg','Meenakshi (CS)',' ');?>
									...
									<div class='row-fluid   jeg_animate_sequence jeg_animate_fast fast '  data-speed='150' data-offset='90' > 
										<?php details('harshit.jpg','Harshit Gupta (CS)','8765630745');?>
									</div>
