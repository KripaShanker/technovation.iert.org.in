...
<div id="loading" data-type="circle">
	<div class="relative" id="loader">
			...
			<img style="width: 270px; height: 270px;" alt=""  src="wp-content/uploads/2014/05/logo_load.png">
		</div>
...
<li id="menu-item-330" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-330 bgnav childindent "><a href="mirth.html">&nbsp;&nbsp;— &nbsp;&nbsp;Mirth</a></li>
	...
	<div class="mobile-social mobile-menu-content">
		<h2>Social Link</h2>
		<ul><li><a target='_blank' href='https://www.facebook.com/technovationiert' class='social-facebook'><i class='fa fa-facebook'></i>Facebook</a></li></ul>	</div>
...
<section 
		...
		<em>We present our gratitutde to the generous sponsors for Technovation 2k16.</em>
