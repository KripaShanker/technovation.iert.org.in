...
<div class='span4  jeg_do_animate   '  data-animation="janimate-fadein"   data-transform="janimate-scale"   data-position="janimpos-bottom" > <a href="blitz.php" ><img class="size-full wp-image-10 aligncenter imgedit" src="assets/images/blitzobotrix.png" alt="villa-hotel" width="200" /></a></p>
<p style="text-align: center;"><a href='blitz.php'  class='btn mb-20 btn-success'>Blitzobotics</a>
</div> 

<div class='span4  jeg_do_animate   '  data-animation="janimate-fadein"   data-transform="janimate-scale"   data-position="janimpos-bottom" ><a href="apex.php" ><img class="aligncenter size-full wp-image-372 imgedit" src="assets/images/3.jpg" alt="demo7_bike" width="200" /></a></p>
<p style="text-align: center;"><a href='bike/index.php'  class='btn mb-20 btn-success'>Apex</a>
</div> </div>
...
<div class='span4  jeg_do_animate   '  data-animation="janimate-fadein"   data-transform="janimate-scale"   data-position="janimpos-bottom" > <a href="paheli.php" ><img class="size-full wp-image-14 aligncenter" src="assets/images/6.png" alt="freelancer" width="200" /></a></p>
